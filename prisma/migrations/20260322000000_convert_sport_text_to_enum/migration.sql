...
UPDATE "leagues" SET "sport" = 'OTHER' WHERE "sport" NOT IN ('HOCKEY', 'LACROSSE', 'SOCCER', 'BASKETBALL', 'BASEBALL', 'SOFTBALL', 'FOOTBALL', 'VOLLEYBALL', 'OTHER');
...
ALTER TABLE "leagues" ALTER COLUMN "sport" TYPE "Sport" USING ("sport"::"Sport");
ALTER TABLE "leagues" ALTER COLUMN "sport" SET DEFAULT 'HOCKEY';
